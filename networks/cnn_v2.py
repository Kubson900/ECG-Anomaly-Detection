...
class CNNv2(Model, InterfaceModelUtilities):
    def __init__(self, num_classes: int = 5, sampling_rate: int = 100):
        ...
        self.cnn_block_4 = CNNBlock(filters=256)
        self.cnn_block_5 = CNNBlock(filters=512)
    ...
    def model_name(self) -> str:
        return f"cnn_v2_{self._sampling_rate}"
